...
namespace App\MoonShine\Resources\SpacexLdnDcAppMetricReport;
...
use App\MoonShine\Resources\SpacexLdnDcAppMetricReport\Pages\SpacexLdnDcAppMetricReportIndexPage;
...
/**
 * @extends ModelResource<SpacexLdnDcAppMetricReport, SpacexLdnDcAppMetricReportIndexPage, SpacexLdnDcAppMetricReportFetchPage>
 */
class SpacexLdnDcAppMetricReportResource extends ModelResource implements HasImportExportContract
{
    use ImportExportConcern;

    protected string $model        = SpacexLdnDcAppMetricReport::class;
    ...
    public function getItemsPerPage(): int
    {
        ...
        $value   = (int) (session()?->get('spacexLdnDcAppMetricPerPage') ?? $default);
    ...
    {
        return [
            SpacexLdnDcAppMetricReportIndexPage::class,
    ...
    protected function handlers(): ListOf
    {
        return new ListOf(Handler::class, [
            ExportHandler::make('Export Excel')->alias('export-excel')->filename('spacex_ldn_dc_app_metric_' . date('Ymd-His'))->forceSort('trx_date'),
            ExportHandler::make('Export CSV')->alias('export-csv')->csv()->filename('spacex_ldn_dc_app_metric_' . date('Ymd-His'))->forceSort('trx_date'),
        ]);
    }
}
