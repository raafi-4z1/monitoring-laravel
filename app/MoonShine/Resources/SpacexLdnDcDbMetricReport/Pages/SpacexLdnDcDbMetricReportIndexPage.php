...
/**
 * @extends IndexPage<SpacexLdnDcDbMetricReportResource>
 */
class SpacexLdnDcDbMetricReportIndexPage extends IndexPage
{
    ...
    protected function modifyListComponent(ComponentContract $component): ComponentContract
    {
        return $component
            ...
            ->stickyButtons()
            ->async(events: [
                AlpineJs::event(JsEvent::FRAGMENT_UPDATED, 'spacex-ldn-dc-db-metric-charts'),
            ])
            ->topRight(function () {
                return [
                    Div::make([
    ...
    public function changePerPage(): JsonResponse
    {
        ...
        if ($perPage > 0) {
            session(['spacexLdnDcDbMetricPerPage' => $perPage]);
        }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            ...
            Fragment::make([$this->buildCharts($data, $period, $metricTypeFilter)])
                ->name('spacex-ldn-dc-db-metric-charts')
                ->withQueryParams(),
        ];
    }
    ...
    {
        $latest = SpacexLdnDcDbMetricReport::latest('trx_date')->latest('trx_hour')->first();
        return $latest
    ...
    private function getFilteredData(): array
    {
        ...
        $data = SpacexLdnDcDbMetricReport::query()
