...
namespace App\MoonShine\Resources\SpacexLdnDcDbMetricReport;
...
use App\MoonShine\Resources\SpacexLdnDcDbMetricReport\Pages\SpacexLdnDcDbMetricReportIndexPage;
...
/**
 * @extends ModelResource<SpacexLdnDcDbMetricReport, SpacexLdnDcDbMetricReportIndexPage, SpacexLdnDcDbMetricReportFetchPage>
 */
class SpacexLdnDcDbMetricReportResource extends ModelResource implements HasImportExportContract
{
    use ImportExportConcern;

    protected string $model        = SpacexLdnDcDbMetricReport::class;
    ...
    public function getItemsPerPage(): int
    {
        ...
        $value   = (int) (session()?->get('spacexLdnDcDbMetricPerPage') ?? $default);
    ...
    {
        return [
            SpacexLdnDcDbMetricReportIndexPage::class,
    ...
    protected function handlers(): ListOf
    {
        return new ListOf(Handler::class, [
            ExportHandler::make('Export Excel')->alias('export-excel')->filename('spacex_ldn_dc_db_metric_' . date('Ymd-His'))->forceSort('trx_date'),
            ExportHandler::make('Export CSV')->alias('export-csv')->csv()->filename('spacex_ldn_dc_db_metric_' . date('Ymd-His'))->forceSort('trx_date'),
        ]);
    }
}
