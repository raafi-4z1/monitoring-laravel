...
namespace App\MoonShine\Resources\SpacexLdnFileArchiveReport\Pages;
...
/**
 * @extends FormPage<SpacexLdnFileArchiveReportResource>
 */
class SpacexLdnFileArchiveReportFetchPage extends FormPage
{
    use GuardsFetchPageAccess;

    public function getTitle(): string
    {
        return 'Fetch Data File Archive dari Elasticsearch (via Grafana)';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data File Archive dari Elasticsearch (via Grafana)'),
            ...
            Alert::make(type: 'info')
                ->content('⏳ Data diambil dari index <strong>reportingkcln-*</strong> (log_category: FILE_CHECK, server: london_dc).'),
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('spacex-ldn-file-archive-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'spacex-ldn-file-archive-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(SpacexLdnFileArchiveReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
