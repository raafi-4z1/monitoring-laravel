...
/**
 * @extends FormPage<SpacexLdnJobExecutionReportResource>
 */
class SpacexLdnJobExecutionReportFetchPage extends FormPage
{
        ...
        return [
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('spacex-ldn-job-execution-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'spacex-ldn-job-execution-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
