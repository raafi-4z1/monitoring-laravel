...
/**
 * @extends IndexPage<SpacexNycDcAppMetricReportResource>
 */
class SpacexNycDcAppMetricReportIndexPage extends IndexPage
{
    ...
    protected function modifyListComponent(ComponentContract $component): ComponentContract
    {
        return $component
            ...
            ->stickyButtons()
            ->async(events: [
                AlpineJs::event(JsEvent::FRAGMENT_UPDATED, 'spacex-nyc-dc-app-metric-charts'),
            ])
            ->topRight(function () {
                return [
                    Div::make([
    ...
    public function changePerPage(): JsonResponse
    {
        ...
        if ($perPage > 0) {
            session(['spacexNycDcAppMetricPerPage' => $perPage]);
        }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            ...
            Fragment::make([$this->buildCharts($data, $period, $metricTypeFilter)])
                ->name('spacex-nyc-dc-app-metric-charts')
                ->withQueryParams(),
        ];
    }
    ...
    {
        $latest = SpacexNycDcAppMetricReport::latest('trx_date')->latest('trx_hour')->first();
        return $latest
    ...
    private function getFilteredData(): array
    {
        ...
        $data = SpacexNycDcAppMetricReport::query()
