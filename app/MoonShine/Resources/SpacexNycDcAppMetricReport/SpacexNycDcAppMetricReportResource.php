...
namespace App\MoonShine\Resources\SpacexNycDcAppMetricReport;
...
use App\MoonShine\Resources\SpacexNycDcAppMetricReport\Pages\SpacexNycDcAppMetricReportIndexPage;
...
/**
 * @extends ModelResource<SpacexNycDcAppMetricReport, SpacexNycDcAppMetricReportIndexPage, SpacexNycDcAppMetricReportFetchPage>
 */
class SpacexNycDcAppMetricReportResource extends ModelResource implements HasImportExportContract
{
    use ImportExportConcern;

    protected string $model        = SpacexNycDcAppMetricReport::class;
    protected string $column       = 'trx_date';
    protected string $title        = 'APP Metric (DC)';
    ...
    public function getItemsPerPage(): int
    {
        ...
        $value   = (int) (session()?->get('spacexNycDcAppMetricPerPage') ?? $default);
    ...
    {
        return [
            SpacexNycDcAppMetricReportIndexPage::class,
    ...
    protected function handlers(): ListOf
    {
        return new ListOf(Handler::class, [
            ExportHandler::make('Export Excel')->alias('export-excel')->filename('spacex_nyc_dc_app_metric_' . date('Ymd-His'))->forceSort('trx_date'),
            ExportHandler::make('Export CSV')->alias('export-csv')->csv()->filename('spacex_nyc_dc_app_metric_' . date('Ymd-His'))->forceSort('trx_date'),
        ]);
    }
}
