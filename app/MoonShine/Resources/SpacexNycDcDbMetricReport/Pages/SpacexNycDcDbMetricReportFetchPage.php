...
/**
 * @extends FormPage<SpacexNycDcDbMetricReportResource>
 */
class SpacexNycDcDbMetricReportFetchPage extends FormPage
{
    use GuardsFetchPageAccess;

    public function getTitle(): string
    {
        return 'Fetch Data DB Metric (DC) New York dari Elasticsearch (via Grafana)';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data DB Metric (DC) New York dari Elasticsearch (via Grafana)'),
            ...
            Alert::make(type: 'info')
                ->content('⏳ Data diambil dari index <strong>metricbeat-*</strong> (agent.name: REPODBNYADC), metric CPU/Memory/Filesystem.'),
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('spacex-nyc-dc-db-metric-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'spacex-nyc-dc-db-metric-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
