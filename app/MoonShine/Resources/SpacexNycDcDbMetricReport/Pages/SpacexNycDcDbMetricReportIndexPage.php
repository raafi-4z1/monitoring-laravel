...
/**
 * @extends IndexPage<SpacexNycDcDbMetricReportResource>
 */
class SpacexNycDcDbMetricReportIndexPage extends IndexPage
{
    ...
    protected function modifyListComponent(ComponentContract $component): ComponentContract
    {
        return $component
            ...
            ->stickyButtons()
            ->async(events: [
                AlpineJs::event(JsEvent::FRAGMENT_UPDATED, 'spacex-nyc-dc-db-metric-charts'),
            ])
            ->topRight(function () {
                return [
                    Div::make([
    ...
    public function changePerPage(): JsonResponse
    {
        ...
        if ($perPage > 0) {
            session(['spacexNycDcDbMetricPerPage' => $perPage]);
        }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            ...
            Fragment::make([$this->buildCharts($data, $period, $metricTypeFilter)])
                ->name('spacex-nyc-dc-db-metric-charts')
                ->withQueryParams(),
        ];
    }
    ...
    {
        $latest = SpacexNycDcDbMetricReport::latest('trx_date')->latest('trx_hour')->first();
        return $latest
    ...
    private function getFilteredData(): array
    {
        ...
        $data = SpacexNycDcDbMetricReport::query()
