...
namespace App\MoonShine\Resources\SpacexNycDcDbMetricReport;

use App\Models\SpacexNycDcDbMetricReport;
use App\MoonShine\Handlers\GuardedExportHandler as ExportHandler;
use App\MoonShine\Resources\SpacexNycDcDbMetricReport\Pages\SpacexNycDcDbMetricReportFetchPage;
use App\MoonShine\Resources\SpacexNycDcDbMetricReport\Pages\SpacexNycDcDbMetricReportIndexPage;
...
/**
 * @extends ModelResource<SpacexNycDcDbMetricReport, SpacexNycDcDbMetricReportIndexPage, SpacexNycDcDbMetricReportFetchPage>
 */
class SpacexNycDcDbMetricReportResource extends ModelResource implements HasImportExportContract
{
    use ImportExportConcern;

    protected string $model        = SpacexNycDcDbMetricReport::class;
    protected string $column       = 'trx_date';
    protected string $title        = 'DB Metric (DC)';
    ...
    public function getItemsPerPage(): int
    {
        ...
        $value   = (int) (session()?->get('spacexNycDcDbMetricPerPage') ?? $default);
    ...
    {
        return [
            SpacexNycDcDbMetricReportIndexPage::class,
            SpacexNycDcDbMetricReportFetchPage::class,
        ];
    }
    ...
    protected function handlers(): ListOf
    {
        return new ListOf(Handler::class, [
            ExportHandler::make('Export Excel')->alias('export-excel')->filename('spacex_nyc_dc_db_metric_' . date('Ymd-His'))->forceSort('trx_date'),
            ExportHandler::make('Export CSV')->alias('export-csv')->csv()->filename('spacex_nyc_dc_db_metric_' . date('Ymd-His'))->forceSort('trx_date'),
        ]);
    }
}
