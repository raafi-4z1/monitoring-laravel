...
/**
 * @extends FormPage<SpacexNycFileArchiveReportResource>
 */
class SpacexNycFileArchiveReportFetchPage extends FormPage
{
    use GuardsFetchPageAccess;

    public function getTitle(): string
    {
        return 'Fetch Data File Archive (New York) dari Elasticsearch (via Grafana)';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data File Archive (New York) dari Elasticsearch (via Grafana)'),
            ...
            Alert::make(type: 'info')
                ->content('⏳ Data diambil dari index <strong>reportingkcln-*</strong> (log_category: FILE_CHECK, server: newyork_dc).'),
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('spacex-nyc-file-archive-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'spacex-nyc-file-archive-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(SpacexNycFileArchiveReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
