...
/**
 * @extends IndexPage<SpacexNycJobExecutionReportResource>
 */
class SpacexNycJobExecutionReportIndexPage extends IndexPage
{
    ...
    public function changePerPage(): JsonResponse
    {
        ...
        if ($perPage > 0) {
            session(['spacexNycJobExecutionPerPage' => $perPage]);
        }
    ...
    {
        $latestDate = SpacexNycJobExecutionReport::max('trx_date');
        ...
        $rows = SpacexNycJobExecutionReport::query()
    ...
    {
        $latest = SpacexNycJobExecutionReport::latest('trx_date')->first();
