...
/**
 * @extends FormPage<SystemOnlineReportResource>
 */
class SystemOnlineReportFetchPage extends FormPage
{
                    ...
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'system-online-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(SystemOnlineReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
