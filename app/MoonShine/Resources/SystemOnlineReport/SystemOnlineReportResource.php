...
class SystemOnlineReportResource extends ModelResource implements HasImportExportContract
{
    ...
    protected function handlers(): ListOf
    {
        return new ListOf(Handler::class, [
            ExportHandler::make('Export Excel')->alias('export-excel')->filename('system_online_' . date('Ymd-His')),
            ExportHandler::make('Export CSV')->alias('export-csv')->csv()->filename('system_online_' . date('Ymd-His')),
        ]);
    }
}
