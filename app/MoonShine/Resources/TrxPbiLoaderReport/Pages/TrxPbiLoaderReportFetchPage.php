...
/**
 * @extends FormPage<TrxPbiLoaderReportResource>
 */
class TrxPbiLoaderReportFetchPage extends FormPage
{
        ...
        return [
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('trx-pbi-loader-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'trx-pbi-loader-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(TrxPbiLoaderReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
