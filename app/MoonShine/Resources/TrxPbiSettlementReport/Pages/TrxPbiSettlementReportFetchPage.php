...
/**
 * @extends FormPage<TrxPbiSettlementReportResource>
 */
class TrxPbiSettlementReportFetchPage extends FormPage
{
    public function getTitle(): string
    {
        return 'Fetch Data TrxPBI Settlement dari Elasticsearch';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data TrxPBI Settlement dari Elasticsearch'),
            ...
            Div::make([
                ...
                FormBuilder::make()
                    ...
                    ->name('trx-pbi-settlement-fetch-form')
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'trx-pbi-settlement-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(TrxPbiSettlementReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
