...
/**
 * @extends FormPage<WicDbMetricReportResource>
 */
class WicDbMetricReportFetchPage extends FormPage
{
    public function getTitle(): string
    {
        return 'Fetch Data WIC DB Metric dari Elasticsearch';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data WIC DB Metric dari Elasticsearch'),
                    ...
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'wic-db-metric-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(WicDbMetricReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
