...
namespace App\MoonShine\Resources\WicDbMetricReport;

use App\Models\WicDbMetricReport;
use App\MoonShine\Resources\WicDbMetricReport\Pages\WicDbMetricReportFetchPage;
use App\MoonShine\Resources\WicDbMetricReport\Pages\WicDbMetricReportIndexPage;
...
/**
 * @extends ModelResource<WicDbMetricReport, WicDbMetricReportIndexPage, WicDbMetricReportFetchPage>
 */
class WicDbMetricReportResource extends ModelResource implements HasImportExportContract
{
    use ImportExportConcern;

    protected string $model        = WicDbMetricReport::class;
    protected string $column       = 'trx_date';
    protected string $title        = 'WIC DB Metric';
    ...
    public function getItemsPerPage(): int
    {
        ...
        $value   = (int) (session()?->get('wicDbMetricPerPage') ?? $default);
    ...
    {
        return [
            WicDbMetricReportIndexPage::class,
