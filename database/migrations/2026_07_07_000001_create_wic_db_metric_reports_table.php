...
return new class extends Migration
{
    ...
    {
        Schema::create('wic_db_metric_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('p95_pct', 8, 4)->nullable();  // p95 utilization (0–1)
    ...
    {
        Schema::dropIfExists('wic_db_metric_reports');
    }
};
