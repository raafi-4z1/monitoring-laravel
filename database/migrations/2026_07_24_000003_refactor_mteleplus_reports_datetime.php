...
{
    private const TABLE     = 'mteleplus_reports';
    private const UNIQ_NAME = 'mteleplus_trx_uniq';
    private const IDX_NAME  = 'mteleplus_trx_date_idx';
    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn(self::TABLE, 'report_hour')) {
            Schema::table(self::TABLE, function (Blueprint $t) {
                $this->dropIndexIfExists($t, 'mteleplus_reports_report_hour_unique');
                $this->dropIndexIfExists($t, 'mteleplus_reports_report_hour_index');
