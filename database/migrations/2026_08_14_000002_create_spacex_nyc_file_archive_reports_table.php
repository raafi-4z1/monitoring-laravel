...
return new class extends Migration
{
    ...
    {
        Schema::create('spacex_nyc_file_archive_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['filename', 'trx_date'], 'spacex_nyc_file_archive_filename_date_uniq');
            $table->index('trx_date', 'spacex_nyc_file_archive_trx_date_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('spacex_nyc_file_archive_reports');
    }
};
