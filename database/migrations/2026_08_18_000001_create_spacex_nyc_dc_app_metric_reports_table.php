...
return new class extends Migration
{
    ...
    {
        Schema::create('spacex_nyc_dc_app_metric_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['trx_date', 'trx_hour', 'metric_type', 'disk_path'], 'spacex_nyc_dc_app_metric_uniq');
            $table->index('trx_date', 'spacex_nyc_dc_app_metric_trx_date_idx');
            $table->index('metric_type', 'spacex_nyc_dc_app_metric_type_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('spacex_nyc_dc_app_metric_reports');
    }
};
